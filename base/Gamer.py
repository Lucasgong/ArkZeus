...
class PhoneGamer(Gamer):
    ...
    def swipe(self, x1, y1, x2, y2, use_time=False, duration=3):
        ...
        if use_time:
            os.system(f'adb shell input swipe {x1} {y1} {x2} {y2} {use_time}')
        else:
    ...
    def screenshot(self, num=0, name='screen'):
        os.system(f'adb exec-out screencap -p > data/{name}.png')
    ...
    def click_image(self, pic_path, screen_name='screen'):
        # find pic location
